...
sed -i 's|/bin/sh|/usr/bin/bash|g' $RPM_BUILD_ROOT/usr/bin/subsearch
...
* Thu Apr 09 2020 Unitedrpms Project <unitedrpms AT protonmail DOT com> 1.4-10
...
* Wed Apr 10 2019 Unitedrpms Project <unitedrpms AT protonmail DOT com> 1.3.1-9
- Updated to current svn revision

* Fri Mar 22 2019 Unitedrpms Project <unitedrpms AT protonmail DOT com> 1.3.1-8
- Rebuilt for x264

* Wed Jan 02 2019 Unitedrpms Project <unitedrpms AT protonmail DOT com> 1.3.1-7
- Updated to 1.3.1
